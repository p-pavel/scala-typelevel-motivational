...
trait PlayingWithIdentifier:
  ...
  /**
    * Looking at the [docs](https://cassandra.apache.org/doc/latest/cassandra/developing/cql/definitions.html#identifiers)
    * we now that:
    ...
    * 
    * Let specify what we learned from the docs to this point. The main reason
    * of this part is to show how we can use the type system to reason about the
    * problem at hand
    */
  ...
  /**
    * This gives us a row idea of sub-types/sub-sets representation of the problem 
    * domain. 
    * 
